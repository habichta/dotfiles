...
vim.api.nvim_set_keymap('n', '<Leader>m', ':AerialNavToggle<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<Leader>mf', ':call aerial#fzf()<CR>', { noremap = true, silent = true })
